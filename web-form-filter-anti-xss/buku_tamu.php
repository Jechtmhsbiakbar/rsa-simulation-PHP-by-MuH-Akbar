<?php
// ============================================================
// BUKU TAMU VERSI RENTAN (VULNERABLE)
// Praktikum Kriptografi - Anti XSS
// PERINGATAN: File ini sengaja dibuat rentan untuk tujuan edukasi
// ============================================================
...
<body>
    <nav class="navbar">
        <a href="buku_tamu.php" class="nav-link nav-aktif">⚠ Buku Tamu (Rentan)</a>
        <a href="buku_tamu_aman.php" class="nav-link nav-lain">✅ Buku Tamu (Aman)</a>
    </nav>

    <h1>📖 Buku Tamu <span class="label-rentan">⚠ VERSI RENTAN</span></h1>
    ...
    <div class="komentar-header">
        <h2 style="margin:0;">Daftar Komentar <span class="jumlah-info">(<?= $jumlah_komentar ?> komentar)</span></h2>
        <?php if ($jumlah_komentar > 0): ?>
            <form method="POST" action="buku_tamu.php" class="form-hapus"
    ...
    if (empty($daftar_komentar)) {
        ...
        foreach ($daftar_komentar as $baris) {
            ...
            echo '<span class="nama">' . $nama . '</span>: ';
            echo $komentar;
            echo '</div>';
        }
    }
